...
@class ApptimizeVariableArray;
@class ApptimizeVariableDictionary;
 ...
 */
@interface ApptimizeVariableArray : ApptimizeVariable
/**
 ...
 * @return Returns the default value if there is an issue with the incoming variant data.
 */
@property (nonatomic, readonly) NSArray* _Nullable arrayValue;
@end
 ...
 */
@interface ApptimizeVariableDictionary : ApptimizeVariable
/**
 ...
 * @return Returns the default value if there is an issue with the incoming variant data.
 */
@property (nonatomic, readonly) NSDictionary* _Nullable dictionaryValue;
@end
